...
public:
    ...
    inline bool is_departing() const {
        return flags[Ship::Ship_Flags::Depart_warp]
            || flags[Ship::Ship_Flags::Depart_dockbay];
    }
    inline bool cannot_warp_flags() const {
        return flags[Ship::Ship_Flags::Warp_broken]
            || flags[Ship::Ship_Flags::Warp_never]
            || flags[Ship::Ship_Flags::Disabled]
            || flags[Ship::Ship_Flags::No_subspace_drive];
    }
...
public:
    ...
    inline bool is_small_ship() const {
        return flags[Ship::Info_Flags::Fighter]
            || flags[Ship::Info_Flags::Bomber]
            || flags[Ship::Info_Flags::Support]
            || flags[Ship::Info_Flags::Escapepod];
    }
    inline bool is_big_ship() const {
        return flags[Ship::Info_Flags::Cruiser]
            || flags[Ship::Info_Flags::Freighter]
            || flags[Ship::Info_Flags::Transport]
            || flags[Ship::Info_Flags::Corvette]
            || flags[Ship::Info_Flags::Gas_miner]
            || flags[Ship::Info_Flags::Awacs];
    }
    inline bool is_huge_ship() const  {
        return flags[Ship::Info_Flags::Capital]
            || flags[Ship::Info_Flags::Supercap]
            || flags[Ship::Info_Flags::Drydock]
            || flags[Ship::Info_Flags::Knossos_device];
    }
    inline bool is_flyable() const {
        return !(flags[Ship::Info_Flags::Cargo]
            || flags[Ship::Info_Flags::Navbuoy]
            || flags[Ship::Info_Flags::Sentrygun]);
...
bool turret_std_fov_test(const ship_subsys *ss, const vec3d *gvec, const vec3d *v2e, float size_mod = 0);
bool turret_adv_fov_test(const ship_subsys *ss, const vec3d *gvec, const vec3d *v2e, float size_mod = 0);
bool turret_fov_test(const ship_subsys *ss, const vec3d *gvec, const vec3d *v2e, float size_mod = 0);
