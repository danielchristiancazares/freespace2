...
struct weapon_info
{
  ...
  public:
    ...
    inline bool is_homing()             const {
        return wi_flags[Weapon::Info_Flags::Homing_heat]
            || wi_flags[Weapon::Info_Flags::Homing_aspect]
            || wi_flags[Weapon::Info_Flags::Homing_javelin];
    }
    inline bool is_locked_homing()      const {
        return wi_flags[Weapon::Info_Flags::Homing_aspect]
            || wi_flags[Weapon::Info_Flags::Homing_javelin];
    }
    inline bool hurts_big_ships()       const {
        return wi_flags[Weapon::Info_Flags::Bomb]
            || wi_flags[Weapon::Info_Flags::Beam]
            || wi_flags[Weapon::Info_Flags::Huge]
            || wi_flags[Weapon::Info_Flags::Big_only];
    }
