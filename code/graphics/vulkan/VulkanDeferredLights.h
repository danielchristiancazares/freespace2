...
struct SphereLight {
  ...
  void record(const DeferredDrawContext &ctx, vk::Buffer sphereVB, vk::Buffer sphereIB, uint32_t indexCount) const;
};
...
struct CylinderLight {
  ...
  void record(const DeferredDrawContext &ctx, vk::Buffer cylinderVB, vk::Buffer cylinderIB, uint32_t indexCount) const;
};
