...
bool VulkanDevice::initialize() {
	...
	m_surfaceFormats = SCP_vector<vk::SurfaceFormatKHR>(
		deviceValues.surfaceFormats.begin(), deviceValues.surfaceFormats.end());
	m_presentModes = SCP_vector<vk::PresentModeKHR>(
		deviceValues.presentModes.begin(), deviceValues.presentModes.end());
...
bool VulkanDevice::initializeSurface() {
	...
	const vk::detail::ObjectDestroy<vk::Instance, VULKAN_HPP_DEFAULT_DISPATCHER_TYPE> deleter(*m_instance,
#else
	const vk::ObjectDestroy<vk::Instance, VULKAN_HPP_DEFAULT_DISPATCHER_TYPE> deleter(*m_instance,
#endif
		nullptr,
...
uint32_t VulkanDevice::swapchainImageCount() const {
