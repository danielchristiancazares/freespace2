...
VulkanRingBuffer::VulkanRingBuffer(vk::Device device, const vk::PhysicalDeviceMemoryProperties &memoryProps,
  ...
  allocInfo.memoryTypeIndex =
      findMemoryType(requirements.memoryTypeBits,
                     vk::MemoryPropertyFlagBits::eHostVisible | vk::MemoryPropertyFlagBits::eHostCoherent, memoryProps);
...
VulkanRingBuffer::Allocation VulkanRingBuffer::allocate(vk::DeviceSize requestSize, vk::DeviceSize alignmentOverride) {
...
uint32_t VulkanRingBuffer::findMemoryType(uint32_t typeFilter, vk::MemoryPropertyFlags properties,
